    ...
    <div className="fixed inset-0 z-[70] flex items-center justify-center bg-slate-950/65 p-3" dir="rtl" role="dialog" aria-modal="true" data-testid="sales-return-edit-modal">
      <div className="flex max-h-[94vh] w-full max-w-4xl flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-2xl">
        ...
        <div className="overflow-y-auto p-5">
          <div className="mb-4 rounded-xl border border-amber-200 bg-amber-50 p-3 text-sm text-amber-900">يمكن تصحيح الكمية وقيمة وحدة المرتجع ما دام الإشعار لم ينتج عنه رد نقدي. إذا سبق تحريك الخزينة، يجب إلغاء الإشعار وإنشاء مرتجع صحيح جديد حتى يظل الأثر المالي قابلاً للمراجعة.</div>
          {blocked && <div data-testid="sales-return-edit-finance-lock" className="mb-4 rounded-xl border border-red-200 bg-red-50 p-3 text-sm font-bold text-red-700">هذا المرتجع تمت تسويته ماليًا أو إلغاؤه، لذلك لا يقبل التعديل المباشر. استخدم الإلغاء ثم أنشئ المرتجع الصحيح.</div>}
