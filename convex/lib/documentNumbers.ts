...
export type DocumentType = "invoice" | "order" | "shipment" | "repair" | "delivery" | "codSettlement" | "finance" | "creditNote" | "purchaseReceipt" | "purchaseReturn" | "supplierLedger" | "supplierPayment" | "customerLedger";
const config = {
