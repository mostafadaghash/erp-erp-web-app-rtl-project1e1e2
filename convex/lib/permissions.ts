...
export const ROLE_PERMISSIONS: Record<string, string[]> = {
  ...
  manager: [
    ...
    "create_products", "create_customers", "create_orders", "create_invoices", "create_quotes",
    "create_repairs", "create_shipments", "create_deliveries", "create_suppliers",
    "create_expenses", "create_leads",
    "edit_products", "edit_customers", "edit_orders", "price_orders", "edit_invoices", "edit_quotes",
  ...
  sales: [
    ...
    "view_prices",
    "create_orders", "create_invoices", "create_quotes", "create_customers",
    "edit_orders", "price_orders", "edit_quotes", "manage_follow_ups",
