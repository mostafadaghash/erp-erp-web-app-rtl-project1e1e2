...
const applicationTables = {
  ...
  }).index("by_return_number",["returnNumber"]).index("by_purchase_receipt",["purchaseReceiptId"]).index("by_supplier_branch_date",["supplierId","branchId","date"]).index("by_branch_date",["branchId","date"]).index("by_idempotency_key",["idempotencyKey"]).index("by_external_credit_note_key",["externalCreditNoteKey"]).index("by_status",["status"]),
