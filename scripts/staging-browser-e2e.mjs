...
const navigationByRole = {
  admin: {
    ...
    hidden: [],
    smoke: ["التقارير", "سجل العمليات", "تصدير البيانات"],
  },
  manager: {
    visible: [
      "المبيعات والفواتير",
    ...
    smoke: ["المبيعات والفواتير", "المنتجات والمخزون", "التقارير"],
  },
  sales: {
    visible: [
      "المنتجات والمخزون",
    ...
    smoke: ["المبيعات والفواتير", "الأوردرات", "العملاء"],
  },
  customer_service: {
    visible: ["العملاء", "الأوردرات", "الصيانة"],
    hidden: [
      "التقارير",
      "الخزائن والحسابات",
      "الموظفون والصلاحيات",
    ...
    smoke: ["الأوردرات", "الصيانة", "العملاء"],
  },
  technician: {
    visible: ["المنتجات والمخزون", "الصيانة"],
    hidden: [
      "المبيعات والفواتير",
      "التقارير",
      "الخزائن والحسابات",
    ...
    smoke: ["الصيانة", "المنتجات والمخزون"],
  },
  accountant: {
    visible: [
      "المنتجات والمخزون",
    ...
    hidden: ["الموظفون والصلاحيات", "سجل العمليات", "الإعدادات"],
    smoke: ["الخزائن والحسابات", "الأستاذ العام", "التقارير"],
  },
  shipping: {
    visible: ["الأوردرات", "الشحنات الواردة", "التوصيلات"],
    hidden: [
      "المبيعات والفواتير",
      "التقارير",
      "الخزائن والحسابات",
    ...
    smoke: ["الأوردرات", "الشحنات الواردة", "التوصيلات"],
  },
  viewer: {
    visible: [
      "المنتجات والمخزون",
    ...
    smoke: ["المنتجات والمخزون", "العملاء", "المبيعات والفواتير"],
  },
};
