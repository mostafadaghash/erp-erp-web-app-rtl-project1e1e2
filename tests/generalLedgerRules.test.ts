...
test("GL rules use exact cents",()=>{assert.equal(toCents(10.25),1025);assert.equal(fromCents(1025),10.25);for(const x of[-1,NaN,Infinity,.001])assert.throws(()=>toCents(x))});
