...
test("business cycles wait for the professional ERP success copy", () => {
  ...
  assert.doesNotMatch(
    script,
    /تم إنشاء الأوردر بنجاح|تم تحديث حالة الطلب|تم إنشاء سند التوصيل|تم تأكيد الشحن|تم إنشاء الشحنة بنجاح|تم تحديث حالة الشحنة|تم ترحيل مرتجع الشراء|تم إضافة طلب الصيانة بنجاح/,
  );
});
