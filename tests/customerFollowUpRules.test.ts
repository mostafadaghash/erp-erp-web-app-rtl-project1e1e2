...
test("commercial follow-up statuses are derived from workflow state and date", () => {
  assert.equal(
    deriveFollowUpCommercialStatus({ status: "pending", followUpDate: "2026-08-31", asOfDate: "2026-08-30" }),
    "needs_follow_up",
  );
  assert.equal(
    deriveFollowUpCommercialStatus({ status: "pending", followUpDate: "2026-08-30", asOfDate: "2026-08-30" }),
    "today",
  );
  assert.equal(
    deriveFollowUpCommercialStatus({ status: "follow_up_later", followUpDate: "2026-08-29", asOfDate: "2026-08-30" }),
    "overdue",
  );
  assert.equal(
    deriveFollowUpCommercialStatus({ status: "follow_up_later", followUpDate: "2026-09-05", asOfDate: "2026-08-30" }),
    "follow_up_later",
  );
  assert.equal(
    deriveFollowUpCommercialStatus({ status: "completed", followUpDate: "2026-08-20", asOfDate: "2026-08-30" }),
    "completed",
  );
